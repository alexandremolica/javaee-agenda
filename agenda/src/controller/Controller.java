...
public class Controller extends HttpServlet {
	...
	protected void contatos(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		// Criando um objetos que ira receber os dados JavaBeans
	...
	protected void removerContato(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		// recebimento do contado a ser excluido (validador.js)
		String idcon = request.getParameter("idcon");
		// setar varivel idcon JavaBeans
		contato.setIdcon(idcon);
	...
	protected void gerarRelatorio(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			documento.open();
			documento.add(new Paragraph("Lista de constatos: "));
			documento.add(new Paragraph(" "));
			// criar uma tabela
			PdfPTable tabela = new PdfPTable(3);// (3) significa tres colunas
			// Cabecalho
